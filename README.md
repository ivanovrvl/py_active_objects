...
* Для получения текущего времени предпочтительно использовать AO.controller.now(). Это потенциально позволяет отлаживать процессы в режиме эмулированного времени.
